...
const AiCourse = () => {
  ...
  return (
    <div className="ai-course-wrapper">
      <Header />
      <h2
      ...
      >
        AI 추천 코스
        <MdKeyboardArrowDown style={{ fontSize: "2.2rem", verticalAlign: "middle" }} />
      </h2>
          ...
          <div
            ...
            onClick={() => {
              if (valid) {
                ...
                alert("이 코스는 유효하지 않아 상세 페이지로 이동할 수 없습니다.");
              }
            }}
          >
            <div
              ...
              <div className="course-track">
                <div className="track-line">
                  {course.course.slice(0, 5).map((item, idx, arr) => {
                    ...
                    const opacity =
                      denominator > 0
                        ? maxOpacity - ((maxOpacity - minOpacity) * (idx / denominator))
                        : maxOpacity;
                      ...
                      <div className="track-item" key={idx}>
                        ...
                        <div
                          className={`track-label${
                            idx % 2 === 1 ? " track-label-top" : " track-label-bottom"
                          }`}
                          style={{ opacity }}
                        >
                          {item.name}
